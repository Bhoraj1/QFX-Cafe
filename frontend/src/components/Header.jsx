  ...
  return (
    <>
      <header className="sticky top-0 left-0 right-0 bg-white shadow-lg z-50  ">
        <nav
          className={` bg-white w-full md:static md:text-sm md:border-none ${
        ...
        >
          <div className="items-center gap-x-14 px-4 max-w-screen-xl mx-auto md:flex md:px-8">
            ...
            >
              <ul className=" relative z-50 items-center space-y-6 md:flex md:space-x-6 md:space-y-0">
                {navigation.map((item, idx) => {
                  return (
                    <li key={idx}>
                      ...
                      drapdownState.idx == idx &&
                      drapdownState.isActive ? (
                        <div className=" bg-white inset-x-0 w-full top-16 md:absolute md:border-y md:shadow-md md:mt-0">
                  ...
                  {currentUser ? (
                    ...
                    <>
                      ...
                      <Link to="/signup">
                        <a
                          href="javascript:void(0)"
                          className="block py-3 px-4 font-medium text-center text-white bg-indigo-600  active:bg-indigo-700 active:shadow-none rounded-lg shadow md:inline"
                        >
                          Sign in
                        </a>
                      </Link>
